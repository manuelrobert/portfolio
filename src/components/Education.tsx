            ...
            <div className="space-y-10 relative">
              ...
              {education.map((edu, index) => (
                <div key={index} className="relative pl-20 group">
                  ...
                  <div className="card card-hover backdrop-blur-sm bg-opacity-70">
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {certifications.map((cert, index) => (
                <div key={index} className="card card-hover backdrop-blur-sm bg-opacity-70 flex items-start gap-6 group">
                  ...
                  <div>
                    ...
                    <div className="mt-4 flex">
                      <span className="px-3 py-1 text-xs rounded-full bg-primary/10 text-primary">Credential ID: AWS-1234</span>
                    </div>
                  </div>
                </div>
              ))}
              ...
              <div className="bg-gray-light/50 border border-gray/30 rounded-xl p-6 backdrop-blur-sm">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-lg font-semibold">Continuing Education</h4>
