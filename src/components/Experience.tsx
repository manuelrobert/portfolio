    ...
    <section id="experience" className="section bg-background relative">
      ...
      <div className="container-custom relative">
        ...
        <div className="max-w-4xl mx-auto relative">
          {/* Timeline line */}
          <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-secondary to-primary/30 transform md:-translate-x-1/2"></div>
          ...
          {experiences.map((exp, index) => (
            <div key={index} className="mb-16 relative group">
              <div className={`flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} gap-8`}>
                {/* Timeline dot */}
                <div className="absolute left-0 md:left-1/2 top-0 w-5 h-5 rounded-full bg-primary border-4 border-background shadow-lg transform -translate-x-2.5 md:-translate-x-1/2 transition-all duration-300 group-hover:scale-150 group-hover:bg-secondary"></div>
