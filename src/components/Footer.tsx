    ...
    <footer className="relative py-16 overflow-hidden">
      ...
      <div className="container-custom relative">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10 pb-12 border-b border-gray/30">
          <div className="max-w-md">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-gray-dark text-sm">Senior Software Engineer</span>
            </div>
            <p className="text-gray-dark mb-6">
              Node.js Backend Developer & DevOps Expert focused on building scalable, cloud-native solutions with modern technology stacks.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8 md:gap-16">
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#about" className="hover:text-primary transition-colors focus-ring">About</a></li>
                <li><a href="#experience" className="hover:text-primary transition-colors focus-ring">Experience</a></li>
                <li><a href="#skills" className="hover:text-primary transition-colors focus-ring">Skills</a></li>
                <li><a href="#projects" className="hover:text-primary transition-colors focus-ring">Projects</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-2">
                  <Image src="/icons/globe.svg" alt="Portfolio" width={16} height={16} />
                  <a 
        ...
        <div className="flex justify-center gap-4 my-8">
          ...
          >
            <Image src="/icons/globe.svg" alt="Portfolio" width={20} height={20} />
          </a>
        </div>
