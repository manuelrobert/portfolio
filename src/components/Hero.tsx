        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 flex flex-col gap-6">
            <div>
              ...
              <h1 className="heading-xl mb-4 animate-fade-in">
                <span className="text-gradient">Manuel Robert</span>
              </h1>
              <h2 className="text-xl font-semibold text-gray-dark mb-6 animate-fade-in-delay-1 tracking-tight">
                Full Stack Developer & DevOps Specialist
              </h2>
              <p className="text-lg mb-8 animate-fade-in-delay-2 max-w-xl">
                Proactive and solution-oriented professional with 3+ years of experience in the Information
                Technology industry. Eager to develop high-quality products while staying current with trends
                and advancements. Skilled in collaboration, communication, and adapting to rapid
          ...
          <div className="order-1 lg:order-2 flex justify-center">
            <div className="relative w-64 h-64 sm:w-72 sm:h-72 lg:w-80 lg:h-80">
              <div className="absolute inset-0 bg-gradient-to-r from-primary to-secondary rounded-full opacity-20 blur-xl animate-pulse"></div>
              <div className="relative bg-gray-light rounded-full p-3 shadow-lg backdrop-blur-sm border border-gray border-opacity-20 animate-float">
                  ...
                  <div className="bg-background rounded-full overflow-hidden">
                    <div className="p-6 relative h-full flex items-center justify-center">
                      <div className="flex flex-col items-center text-center">
                        ...
                        <h3 className="text-xl font-bold mt-3 mb-1 tracking-tight">
                          <span className="text-gradient">Manuel Robert</span>
                        </h3>
                        <p className="text-xs text-gray-dark font-medium">
                          Senior Software Engineer <br /> Full Stack Developer
                        </p>
                      </div>
                    </div>
                  </div>
